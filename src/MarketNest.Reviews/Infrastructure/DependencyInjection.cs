...
/// </summary>
internal sealed class ReviewPolicyConfigProvider : IReviewPolicyConfig, IReviewPolicyConfigWriter
{
...
public static class ReviewsServiceExtensions
{
    ...
    {
        services.AddSingleton<ReviewPolicyConfigProvider>();
        services.AddSingleton<IReviewPolicyConfig>(sp =>
            sp.GetRequiredService<ReviewPolicyConfigProvider>());
