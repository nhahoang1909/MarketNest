...
public static class DateTimeOffsetExtensions
{
    ...
    private static readonly CompositeFormat SecondAgoFormat =
        CompositeFormat.Parse(DomainConstants.RelativeTime.SecondAgo);

    private static readonly CompositeFormat MinuteAgoFormat =
        CompositeFormat.Parse(DomainConstants.RelativeTime.MinuteAgo);
    ...
    private static readonly CompositeFormat MonthAgoFormat =
        CompositeFormat.Parse(DomainConstants.RelativeTime.MonthAgo);
    ...
    private static string FormatRelativeDays(int days) => days switch
    {
        ...
        < DomainConstants.RelativeTime.DaysPerMonth
            => string.Format(CultureInfo.InvariantCulture, WeekAgoFormat,
                days / DomainConstants.RelativeTime.DaysPerWeek),

        < DomainConstants.RelativeTime.DaysPerYear
            => string.Format(CultureInfo.InvariantCulture, MonthAgoFormat,
                days / DomainConstants.RelativeTime.DaysPerMonth),
