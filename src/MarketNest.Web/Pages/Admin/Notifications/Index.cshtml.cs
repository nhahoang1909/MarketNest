...
namespace MarketNest.Web.Pages.Admin.Notifications;
...
public partial class IndexModel(IAppLogger<IndexModel> logger) : PageModel
{
    ...
    {
        [LoggerMessage((int)LogEventId.AdminNotificationsIndexStart, LogLevel.Information,
            "AdminNotifications OnGet Start - CorrelationId={CorrelationId}")]
