...
namespace MarketNest.Web.Pages.Admin.Storefronts;
...
public partial class IndexModel(IAppLogger<IndexModel> logger) : PageModel
{
    ...
    {
        [LoggerMessage((int)LogEventId.AdminStorefrontsIndexStart, LogLevel.Information,
            "AdminStorefronts OnGet Start - CorrelationId={CorrelationId}")]
