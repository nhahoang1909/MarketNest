...
namespace MarketNest.Web.Pages.Admin.Products;
...
public partial class IndexModel(IAppLogger<IndexModel> logger) : PageModel
{
    ...
    {
        [LoggerMessage((int)LogEventId.AdminProductsIndexStart, LogLevel.Information,
            "AdminProducts OnGet Start - CorrelationId={CorrelationId}")]
