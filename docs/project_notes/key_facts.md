...
- **Latest updates (2026-05-01)**: 
  ...
  - Catalog module folder restructuring with centralized audit event types
  - 13 Roslyn analyzer rule violations fixed (MN020, MN021, MN029, MN030)
  - Announcement feature foundation (ADR-043)
